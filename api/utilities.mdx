...
description: "Four pure utility functions for price formatting, quantity conversion, coin name extraction, and fee percentage calculation used across the order pipeline."
---
