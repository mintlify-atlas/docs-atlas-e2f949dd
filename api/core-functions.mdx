...
description: "The commit_* and fetch_* functions are the low-level primitives underlying WalletPublicService, accepting a Binance instance directly for use in custom broker adapters."
---
