...
description: "Wallet Manager enforces the Binance spot order sequence: cancel pending orders, verify a clean book, then sell to prevent locked-balance errors."
---
