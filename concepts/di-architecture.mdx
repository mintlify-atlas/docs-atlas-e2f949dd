...
description: "Wallet Manager uses di-kit for inversion-of-control wiring, binding WalletPrivateService and WalletPublicService to DI symbols resolved at startup."
---
