...
description: "The REPL evaluates raw JavaScript with await, pretty-prints results as JSON, and injects wallet and fs globals for hands-on Binance spot control."
---
